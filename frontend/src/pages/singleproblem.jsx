...
const ProblemPage = () => {
  ...
  useEffect(() => {
    const fetchProblem = async () => {
      ...
      try{
            ...
            const response = await fetch('http://localhost:5000/problems/singleproblem', {
              method: 'POST',
              headers: {
  ...
  const handleBookmark = async () => {
      try {
        ...
        const updateRes = await fetch('http://localhost:5000/user/setbookmark', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
...
const handleSubmitSolution = async () => {
    ...
    const payload = {
      ...
      try {
        const res = await fetch('http://localhost:5000/solutions/create', {
          method: 'POST',
